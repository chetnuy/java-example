...
/**
 * Программа подрубается к http серверу, и может проходить аутентификацию-
 */
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            for (Map.Entry<String,
                    List<String>> entry : headers.entrySet()) {
            ...
            // вывести первые десять строк запрашиваемого содержимого
                for (int n = 1; in.hasNextLine() && n <= 20; n++)
